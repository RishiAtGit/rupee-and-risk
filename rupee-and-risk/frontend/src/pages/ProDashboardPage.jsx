...
export default function ProDashboardPage() {
    ...
    const generatePDF = () => {
        ...
        if (!w) {
            alert("Pop-up blocked! Please allow pop-ups for this site to generate Tear Sheets.");
            setPdfGenerating(false);
            return;
        }
        w.document.write('<html><body style="background:#050505; color:#00e659; display:flex; justify-content:center; align-items:center; height:100vh; font-family:sans-serif;"><h2>Generating Institutional Tear Sheet...</h2></body></html>');
...
<div class="footer"><span>Generated by Rupee And Risk PRO · rupee-and-risk.com</span><span>${new Date().toLocaleDateString('en-IN', { day: '2-digit', month: 'short', year: 'numeric' })}</span></div>
            ...
            // Small delay to ensure styles render before opening print dialog
